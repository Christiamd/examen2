        ...
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests( request ->
                        request.requestMatchers(Constants.ENDPOINTS_PERMIT, Constants.ENDPOINTS_PERMIT_ACTUATOR).permitAll()
                                ...
                                .requestMatchers(Constants.ENDPOINTS_CREAADMIN).hasAnyAuthority(Role.ADMIN.name())
                                .requestMatchers(Constants.ENDPOINTS_CREAUSUARIO).hasAnyAuthority(Role.ADMIN.name())
